...
//        jLabel6.setText(Integer.toString(hour)+"/"+Integer.toString(minute)+"/"+Integer.toString(second));
    ...
    private void initComponents() {
        ...
        jButton9.setText("joined report");
    ...
    private void jButton8ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton8ActionPerformed
        ...
        PdfWriter.getInstance(document,new FileOutputStream("Reports.pdf"));
            document.open();
            Image img=Image.getInstance("ahmad6.jpg");
            document.add(new Paragraph("ahmad"));
            document.add(img);
            ...
            PdfPCell cell1=new PdfPCell(new Paragraph("Database values"));
            cell1.setColspan(2);
            cell1.setHorizontalAlignment(Element.ALIGN_CENTER);
            cell1.setBackgroundColor(BaseColor.GREEN);
            table1.addCell(cell1);
            table1.addCell("Employee Name");
            table1.addCell(jTextField2.getText());
            table1.addCell("Employee Mobile");
            table1.addCell(jTextField3.getText());
            document.add(table1);
    ...
    private void jButton9ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton9ActionPerformed
         try{
            PdfReader report=new PdfReader("reports.pdf");
            PdfReader report1=new PdfReader("reports1.pdf");
            PdfCopyFields copy=new PdfCopyFields(new FileOutputStream("Joined reports.pdf"));
