...
ResultSet rs=null;
    ...
    private void initComponents() {
        ...
        jButton5.setText("pie chart database");
        ...
        jButton7.setText("bar chart database");
        ...
        jButton8.setText("line chart database");
...
//        jLabel5.setText(Integer.toString(date)+"/"+Integer.toString(month+1)+"/"+Integer.toString(year));
    ...
    private void jButton5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton5ActionPerformed
        String pressure=jTextField6.getText();
        String temperature=jTextField7.getText();
        String volumeflow=jTextField8.getText();
        String rotationalspeed=jTextField9.getText();
        
        DefaultPieDataset pie_dataset=new DefaultPieDataset();
        pie_dataset.setValue("pressure",new Double(pressure));
        pie_dataset.setValue("temperature",new Double(temperature));
        pie_dataset.setValue("volumeflow",new Double(volumeflow));
        pie_dataset.setValue("rotationalspeed",new Double(rotationalspeed));
    ...
    private void jButton6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton6ActionPerformed
        ...
        dataset.setValue(95, "marks", "student2");
        dataset.setValue(75, "marks", "student3");
        dataset.setValue(60, "marks", "student4");
    ...
    private void jButton7ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton7ActionPerformed
        String pressure=jTextField6.getText();
        String temperature=jTextField7.getText();
        String volumefolw=jTextField8.getText();
        String rotationalspeed=jTextField9.getText();
        
        DefaultCategoryDataset dataset=new DefaultCategoryDataset();
        dataset.setValue(new Double(pressure), "values", "pressure");
        dataset.setValue(new Double(temperature), "values", "temperature");
        dataset.setValue(new Double(volumefolw), "values", "volumefolw");
        dataset.setValue(new Double(rotationalspeed), "values", "rotationalspeed");
        
        JFreeChart chart=ChartFactory.createBarChart3D("parameter values","parameter","values", dataset,PlotOrientation.VERTICAL,false,true,false);
        CategoryPlot p=chart.getCategoryPlot();
        chart.setBackgroundPaint(Color.YELLOW);
        chart.getTitle().setPaint(Color.RED);
        p.setRangeGridlinePaint(Color.GREEN);
        ChartFrame frame=new ChartFrame("bar chart for parameter",chart);
        frame.setVisible(true);
        frame.setSize(1000,500);
        try{
            final ChartRenderingInfo info=new ChartRenderingInfo(new StandardEntityCollection());
            final File f1=new File("chart.png");
            ChartUtilities.saveChartAsPNG(f1, chart, 600,400);
        }
        catch(Exception e){
            JOptionPane.showMessageDialog(this, e);
        }
    ...
    private void jButton8ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton8ActionPerformed
        ...
        JFreeChart chart=ChartFactory.createLineChart3D("parameter values","parameter","values", dataset,PlotOrientation.VERTICAL,false,true,false);
        CategoryPlot p=chart.getCategoryPlot();
        chart.setBackgroundPaint(Color.YELLOW);
        chart.getTitle().setPaint(Color.RED);
        p.setRangeGridlinePaint(Color.GREEN);
